...
class Business(Model):
    ...
    logo =  fields.CharField(max_length=20, null = False, default = "default.jpg")
...
Product_pydanticOUT= pydantic_model_creator(Product, name ="ProductOUT", exclude=("percentage_discount","id"))
